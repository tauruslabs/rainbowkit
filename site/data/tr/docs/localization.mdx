...
Sayfalar Yönlendiricisi için bir örneği buradan [here](https://github.com/merkletrade/rainbowkit/tree/main/examples/with-next) referans alabilirsiniz.

Uygulama Yönlendiricisi henüz i18n'yi desteklemiyor. En iyi uygulama tekniklerini [`next-intl`](https://github.com/amannn/next-intl) ara yazılımı ile implemente etmek için ayrı örneğimize [here](https://github.com/merkletrade/rainbowkit/tree/main/examples/with-next-app-i18n) bakınız.
...
Eğer ek bir dil desteği görmek isterseniz, lütfen bir [GitHub Tartışması](https://github.com/merkletrade/rainbowkit/discussions/new?category=ideas) açın ve biz bunu en kısa sürede desteklemek için çalışacağız.

---
title: Özel ConnectButton
description: Özel bir ConnectButton oluşturma
---

# Özel ConnectButton

## Özel bir ConnectButton oluşturma

Kendi özel bağlantı düğmenizi oluşturmak için düşük seviye `ConnectButton.Custom` kullanabilirsiniz. Bu bileşen, yerleşik düğmeleri yeniden uygulamanız gereken her şeyi içeren bir fonksiyon oluşturur.

Yerleşik düğmelerin minimal yeniden uygulanması şöyle görünebilir:
...
Aşağıdaki özellikler render fonksiyonunuza geçirilir.

...
> Not: Bu API kararsızdır ve yakın gelecekte değişiklik göstermesi muhtemeldir. Zamanla daha fazla yerleşik cüzdan ekleyeceğiz. Herhangi bir cüzdanla ilgileniyorsanız [bize bildirin](https://github.com/merkletrade/rainbowkit/issues).

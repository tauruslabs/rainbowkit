...
> Note: This API is unstable and likely to change in the near future. We will be adding more built-in wallets over time. [Let us know](https://github.com/merkletrade/rainbowkit/issues) if there are any particular wallets you're interested in.

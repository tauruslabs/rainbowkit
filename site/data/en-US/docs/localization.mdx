...
You can reference an example for the Pages Router [here](https://github.com/merkletrade/rainbowkit/tree/main/examples/with-next).

App Router does not yet support i18n. Reference our separate example [here](https://github.com/merkletrade/rainbowkit/tree/main/examples/with-next-app-i18n) for implementation best practices with [`next-intl`](https://github.com/amannn/next-intl) middleware.

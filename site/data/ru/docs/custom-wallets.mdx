...
> Примечание: АПИ находится в стадии разработки и может измениться в ближайшем будущем. Со временем мы добавим больше встроенных кошельков. [Сообщите нам](https://github.com/merkletrade/rainbowkit/issues) если есть конкретные кошельки, которые вас интересуют.

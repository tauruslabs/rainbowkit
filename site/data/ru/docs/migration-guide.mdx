...
Ссылка на наш [Конфигурация Webpack Next.js](https://github.com/merkletrade/rainbowkit/blob/main/examples/with-next/next.config.js) и [Полифиллы Create React App](https://github.com/merkletrade/rainbowkit/blob/main/examples/with-create-react-app/src/polyfills.ts) образцы для руководства по настройке вашего проекта.

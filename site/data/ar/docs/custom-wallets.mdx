...
> ملاحظة: هذا الواجهة البرمجية للتطبيقات غير مستقرة ومرجح أن تتغير في المستقبل القريب. سنقوم بإضافة المزيد من المحافظ المدمجة مع مرور الوقت. [أعلمنا](https://github.com/merkletrade/rainbowkit/issues) إذا كانت هناك أي محافظ معينة تهمك.

...
**1. ติดตั้ง `@merkletrade/rainbow-button` และ peer dependencies ของมัน**

แพ็กเกจที่เข้ากันได้กับ Next.js, React, และ Vite ตรวจสอบคำเตือนเกี่ยวกับ peer dependency ตรวจสอบคำเตือนเกี่ยวกับ peer dependency ตรวจสอบคำเตือนเกี่ยวกับ peer dependency

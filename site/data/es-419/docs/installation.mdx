...
Consulte nuestra [Configuración de Webpack de Next.js](https://github.com/merkletrade/rainbowkit/blob/main/examples/with-next/next.config.js), [Configuración de Webpack de Next.js App Router](https://github.com/merkletrade/rainbowkit/blob/main/examples/with-next-app/next.config.js), y [Creación de polifills para una aplicación React](https://github.com/merkletrade/rainbowkit/blob/main/examples/with-create-react-app/src/polyfills.ts) ejemplos para la configuración de orientación para su proyecto.

##### Vite

El ensamblador [Vite](https://vitejs.dev) no proporciona polifills de Node, por lo que necesitará incluir polifills para `global`, `Buffer` y `process.env`. Como un ejemplo, puede referenciar los [polifills en nuestro proyecto de muestra Vite](https://github.com/merkletrade/rainbowkit/tree/main/examples/with-vite/src/polyfills.ts).
...
Remix también requiere que hagas polyfill a `global`, `Buffer` y `process.env`. Haga referencia a los [polyfills en nuestro proyecto de ejemplo Remix](https://github.com/merkletrade/rainbowkit/blob/main/examples/with-remix/app/polyfills.ts).
...
Para ver algunos ejemplos ejecutándose de RainbowKit, o incluso usarlos para crear automáticamente un nuevo proyecto, consulte los [ejemplos oficiales](https://github.com/merkletrade/rainbowkit/tree/main/examples).

Para probar RainbowKit directamente en su navegador, consulte los enlaces de CodeSandbox a continuación:

- con [Crear React App](https://codesandbox.io/p/sandbox/github/merkletrade/rainbowkit/tree/main/examples/with-create-react-app)
- con [Next.js](https://codesandbox.io/p/sandbox/github/merkletrade/rainbowkit/tree/main/examples/with-next)
- con [Next.js App Router](https://codesandbox.io/p/sandbox/github/merkletrade/rainbowkit/tree/main/examples/with-next-app)
- con [Remix](https://codesandbox.io/p/sandbox/github/merkletrade/rainbowkit/tree/main/examples/with-remix)
- con [Vite](https://codesandbox.io/p/sandbox/github/merkletrade/rainbowkit/tree/main/examples/with-vite)

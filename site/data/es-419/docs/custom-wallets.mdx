...
> Nota: Esta API es inestable y es probable que cambie en un futuro cercano. Agregaremos más billeteras incorporadas con el tiempo. [Háganos saber](https://github.com/merkletrade/rainbowkit/issues) si hay alguna billetera particular que le interese.

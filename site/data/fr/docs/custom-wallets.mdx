...
> Note : Cette API est instable et susceptible de changer dans un futur proche. Nous ajouterons plus de portefeuilles intégrés avec le temps. [Faites-nous savoir](https://github.com/merkletrade/rainbowkit/issues) s'il y a des portefeuilles particuliers qui vous intéressent.

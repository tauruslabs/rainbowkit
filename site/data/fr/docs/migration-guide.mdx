...
Consultez notre [Config Next.js Webpack](https://github.com/merkletrade/rainbowkit/blob/main/examples/with-next/next.config.js) et les exemples de [polyfills de Create React App](https://github.com/merkletrade/rainbowkit/blob/main/examples/with-create-react-app/src/polyfills.ts) pour obtenir des conseils de configuration pour votre projet.

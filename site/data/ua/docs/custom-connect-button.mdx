...
Ви можете використовувати низькорівневий `ConnectButton.Custom`, щоб створити власну кнопку підключення. Цей компонент відтворює функцію, яка містить усе необхідне для повторного реалізування вбудованих кнопок.

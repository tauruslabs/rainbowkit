...
> Примітка: Цей API є нестабільним і, ймовірно, зазнає змін у найближчому майбутньому. З часом ми додамо більше вбудованих гаманців. [Повідомте нас](https://github.com/merkletrade/rainbowkit/issues), якщо є певні гаманці, які вас цікавлять.

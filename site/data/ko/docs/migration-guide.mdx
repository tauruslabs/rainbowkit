...
[Next.js 웹팩 설정](https://github.com/merkletrade/rainbowkit/blob/main/examples/with-next/next.config.js)와 [Create React App 폴리필들](https://github.com/merkletrade/rainbowkit/blob/main/examples/with-create-react-app/src/polyfills.ts) 샘플을 참조하여 귀하의 프로젝트를 위한 설정 가이드를 참고하세요.

...
Pages Router를 위한 예를 참조하실 수 있습니다 [here](https://github.com/merkletrade/rainbowkit/tree/main/examples/with-next).

App Router는 아직 i18n을 지원하지 않습니다. [`next-intl`](https://github.com/amannn/next-intl) 미들웨어를 사용한 구현의 최상의 사례를 위한 별도의 예제를 참조하십시오 [here](https://github.com/merkletrade/rainbowkit/tree/main/examples/with-next-app-i18n).
...
추가적인 언어를 지원하려면 [GitHub Discussion](https://github.com/merkletrade/rainbowkit/discussions/new?category=ideas)을 열어 주시면 가능한 빨리 지원하도록 노력하겠습니다.

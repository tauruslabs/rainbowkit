...
> Nota: Esta API é instável e provavelmente mudará em um futuro próximo. Estaremos adicionando mais carteiras integradas ao longo do tempo. [Informe-nos](https://github.com/merkletrade/rainbowkit/issues) se houver carteiras específicas que interessem a você.
